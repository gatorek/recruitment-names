defmodule PhoenixApi.Schemas.PersonTest do
  ...
  describe "changeset/2" do
    ...
    test "changeset updates existing person" do
      person = %Person{
        first_name: "Jan",
        last_name: "Kowalski",
        gender: :male,
  ...
  describe "schema fields" do
    test "schema has correct fields" do
      ...
      assert person.inserted_at == ~N[2024-01-01 00:00:00]
      assert person.updated_at == ~N[2024-01-01 00:00:00]
    end
  end
end
